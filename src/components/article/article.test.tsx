...
import {Article} from "./article.component.tsx";
...
describe("Article test", () => {
    test('renders article component', () => {
        ...
        expect(screen.getByText('Article-author')).toBeDefined();
        expect(screen.getByText('ARTICLE-TOPIC')).toBeDefined();
        expect(screen.getByText('Article-post')).toBeDefined();
        expect(screen.getByAltText('Image for article-title')).toBeDefined();
    });
    test('deserializeArticle', () => {
        const articleJson = {
            "id": 97548,
        ...
        const article = deserializeArticle(articleJson);
        expect(article).toEqual({
            "authorName": "cmoullec",
            "date": "2020-08-25T14:00:03",
            "id": 97548,
            "imgUrl": "https://ubuntu.com/wp-content/uploads/5288/Title-Cards.jpg",
            "link": "https://ubuntu.com/blog/travel-clis-and-sticky-notes-lilyanas-life-as-a-canonical-ux-designer/",
            "title": "Travel, CLIs, and sticky notes: Lilyana’s life as a Canonical UX designer",
